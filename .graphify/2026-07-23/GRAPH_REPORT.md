...
- Excluded: 96 untracked · 8437 ignored · 0 sensitive · 0 missing committed
...
Cohesion: 0.12
Nodes (5): cardColors, COLORS, StaggerItem(), StaggerReveal(), toast()

### Community 1 - "Page API Client"
Cohesion: 0.16
Nodes (4): api, fadeUp, stagger, taglines

### Community 2 - "Theme Engine"
Cohesion: 0.13
Nodes (8): ThemeContext, ThemeProvider(), useTheme(), borderWeights, cornerOptions, densities, motionOptions, textures

### Community 3 - "Project Config & Git"
Cohesion: 0.17
Nodes (11): main, 0c09560 Update: ProfilePanel, SessionMenu, API, Dashboard, Landing, Session, server routes and services, 16377a2 Add presentation slides and PDF, 201fa50 Initial commit: LearnMosaic project structure and documentation, 42e6886 Add React frontend with Vite, Tailwind, Framer Motion, 9afa192 Add Express backend with OpenRouter AI integration, c325fc0 Add package lock files, dd4e31d Add PocketBase binary (+3 more)

### Community 4 - "Server Session Routes"
Cohesion: 0.15
Nodes (12): __dirname, promptsDir, router, upload, UPLOAD_DIR, generateImage(), searchDuckDuckGoImages(), searchImages() (+4 more)

### Community 5 - "Onboarding & Inputs"
Cohesion: 0.18
Nodes (4): fadeSlide, goals, interests, stepIcons
...
Cohesion: 0.33
Nodes (2): confettiColors, fadeUp

### Community 8 - "AI Service Layer"
Cohesion: 0.40
Nodes (4): router, callAI(), PROVIDERS, resolveSettings()

### Community 9 - "PocketBase Data Layer"
Cohesion: 0.40
Nodes (4): router, api(), getToken(), pb

## Knowledge Gaps
- **26 isolated node(s):** `COLORS`, `textures`, `densities`, `borderWeights`, `cornerOptions` (+21 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Credits & Milestones`** (2 nodes): `confettiColors`, `fadeUp`
